/**
 * @file TokenExpired.js
 * @brief Token Expired Page Module
 *
 * This module exports a function that renders the Token expired component from
...
import Hourglass from "assets/icons/symbols/hourglass";
...
/**
 * @brief Token Expired Page Component
 */
const TokenExpired = () => {
    /**
     * @brief Variables and hooks
     **/
        ...
        <Flex >
            <Layout style={layoutStyle}>
                ...
                <Content>
                    ...
                    <Hourglass />
                    <MainTitle>{t('auth.expiredLink.title')}</MainTitle>
                    <ConfirmationText>{t('auth.expiredLink.description')} <br />
                        {t('auth.expiredLink.tryAgain')}</ConfirmationText>
                    {
                        isLoading ?
                            ...
                            : <NextStepButton onClick={handleClick}>
                                {t('auth.expiredLink.resend')}
                            </NextStepButton>
                    }
                    <ContactText>{t('auth.expiredLink.contactText')} </ContactText>
                    <StyledLink href="mailto:elit.global@capgemini.com ">{t('auth.expiredLink.contactEmail')} </StyledLink>
                </Content>
            </Layout>
        </Flex>
    );
