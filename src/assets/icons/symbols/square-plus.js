 ...
 * @file square-plus.js
 * @module square-plus
 * @description Ce module exporte un composant SVG représentant une icône square-plus.
 */
export default ({ size }) => {
    const width = size
    const height = size
    return (
        <div className="icon" >
            ...
            >
                ...
                <path d="M12 7C12.5523 7 13 7.44772 13 8V16C13 16.5523 12.5523 17 12 17C11.4477 17 11 16.5523 11 16V8C11 7.44772 11.4477 7 12 7Z"/>
